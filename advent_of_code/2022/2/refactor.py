...
def main():
    ...
    def convert_XYZ_ABC(move: str):
        """ We are only going to use ABC, so convert XYZ """
        #! Can Remove this check if we limit the definition of the function to only take one type of input the key or the value
        # computer = ['A', 'B', 'C']
        # player = ['X', 'Y', 'Z']

        # # Default, Is Value
        # v1, v2 = computer, player
        
        # # Is Key
        # if move in player:
        #     v2, v1 = computer, player
