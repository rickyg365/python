...
# Data
from utils.insert_data import create_entry_list, input_anime_entry_data, input_entry_data
...
if __name__ == '__main__':
    ...
    # new_data = input_entry_data(sample_config, "Shopping Item")

    new_data = create_entry_list(sample_config, "Shopping Item")
